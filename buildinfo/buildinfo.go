...
import (
	...
	"errors"
	"fmt"
	"github.com/ZxillyFork/debug/elf"
	"github.com/ZxillyFork/debug/macho"
	"github.com/ZxillyFork/debug/pe"
	"github.com/ZxillyFork/debug/saferio"
...
func readRawBuildInfo(r io.ReaderAt) (vers, mod string, err error) {
	...
	// See cmd/link/github.com/ZxillyFork/debug/ld.Link.buildinfo.
	...
	if len(mod) >= 33 && mod[len(mod)-17] == '\n' {
		...
		// These are cmd/go/github.com/ZxillyFork/debug/modload.infoStart and infoEnd.
